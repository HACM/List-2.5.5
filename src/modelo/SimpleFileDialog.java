...
public class SimpleFileDialog 
{
	...
	public String Default_File_Name = "Asistencias.xls";
	private String Selected_File_Name = "Asistencias.xls";
	...
	public SimpleFileDialog(Context context, String file_select_type, SimpleFileDialogListener SimpleFileDialogListener)
	{
		...
		else if (file_select_type.equals("GuardarComo"))     Select_type = FileSave;
	...
	public void chooseFile_or_Dir(String dir)
	{
		...
		dialogBuilder.setPositiveButton("Guardar", new OnClickListener() 
		{
			@Override
			...
			DialogInterface.OnClickListener onClickListener)
	{
		...
		if (Select_type == FileSave    ) m_titleView1.setText("Guardar Como:");
		...
		if (Select_type == FolderChoose || Select_type == FileSave)
		{
			...
			newDirButton.setText("Crear Carpeta");
			newDirButton.setOnClickListener(new View.OnClickListener() 
			{
				...
				public void onClick(View v) 
				{
					...
					setTitle("Nombre de la Carpeta:").
					setView(input).setPositiveButton("Crear", new DialogInterface.OnClickListener() 
					{
