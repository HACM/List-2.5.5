...
public class DialogoArchivo {
	...
	public String Default_File_Name = "listado.csv";
	...
	public DialogoArchivo(Context context, String file_select_type,
	...
	public void chooseFile_or_Dir(String dir) {
		...
		dialogBuilder.setPositiveButton("Seleccionar", new OnClickListener() {
			@Override
	...
	private AlertDialog.Builder createDirectoryChooserDialog(String title,
		...
		if (Select_type == FileOpen || Select_type == FileSave) {
			input_text = new TextView(m_context);
