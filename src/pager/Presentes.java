...
public final class Presentes extends Fragment {
	...
	AdaptadorAlumnosPresentes cAdapter;

	public static Presentes newInstance(Activity activi, int layout,int classID, int listaID) {
		Presentes fragment = new Presentes();
	...
	public ListView resfrescarDatos() {
		...
		alumos_data.clear();
		alumos_data = modeloAsistencia.alumnosIdClasePresentes(CLASE_ID,LISTA_ID);
		cAdapter = new AdaptadorAlumnosPresentes(actividad, layoutalumnos, alumos_data);
	...
	public class AdaptadorAlumnosPresentes extends ArrayAdapter<Alumnos> {
		Activity activity;
		int layoutResourceId;
		Alumnos user;
		ArrayList<Alumnos> data = new ArrayList<Alumnos>();

		public AdaptadorAlumnosPresentes(Activity act, int layoutResourceId,
				ArrayList<Alumnos> data) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.tarde.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
                    ...
                    modeloAsistencia.actualizarAsistenciaAlumnos(instancia, LISTA_ID,1);
